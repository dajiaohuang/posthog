...
from products.subscriptions.backend.temporal import (
    ACTIVITIES as SUBSCRIPTIONS_ARTIFACT_ACTIVITIES,
    WORKFLOWS as SUBSCRIPTIONS_ARTIFACT_WORKFLOWS,
)
...
_task_queue_specs = [
    ...
    (
        ...
        + SUBSCRIPTIONS_ARTIFACT_WORKFLOWS
        + ALERT_WORKFLOWS
        + PULSE_WORKFLOWS
        + SYNC_EVENTS_RETENTION_WORKFLOWS,
        EXPORT_ACTIVITIES
        + SUBSCRIPTION_ACTIVITIES
        + SUBSCRIPTIONS_ARTIFACT_ACTIVITIES
        + ALERT_ACTIVITIES
        + PULSE_ACTIVITIES
        + SYNC_EVENTS_RETENTION_ACTIVITIES,
    ),
