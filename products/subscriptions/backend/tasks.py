"""Celery entrypoints for bounded, cross-team Subscription housekeeping."""
...
@skip_team_scope_audit  # Genuine bounded cross-team reconciler; each artifact is reloaded through for_team().
def reconcile_proactive_artifact_adoptions() -> None:
    """Reconcile a small stable batch without holding database work across lifecycle reads."""
